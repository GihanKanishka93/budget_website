<template>
  <div class="container text-start mb-5">
    <div
      class="row justify-content-md-center formbold-form-step-1 wizard-form active"
      step-id="1"
    >
      <div class="header_text">
        <center>
          ...
          <p>
            Please take 20 minutes to complete this form. Your thorough input is
            appreciated.
          </p>
        </center>
      </div>
      ...
      <div class="col-6 ps-5">
        ...
        <div class="mb-3 row">
          <label class="col-5 col-form-label ps-0"
            >Preferred color
            <div class="form-text">
              We will be getting the colors from the logo you uploaded,If you
              don't have a logo please select colors
            </div>
          </label>
          <div class="col-7">
            <div
        ...
        <div class="mb-3 row">
          ...
          <div class="col-7">
            ...
            />
            <div class="form-text">
              ex: – "Elevate your experience with us. Unlock Possibilities,
              Acheive Excellence."
            </div>
          </div>
        </div>
    ...
    <div class="row formbold-form-step-3 wizard-form" step-id="3">
      ...
      <ServicesComponent
        :services="services"
        :service-validate.sync="serviceValidate"
      />
    </div>
    ...
    <div class="row formbold-form-step-5 wizard-form text-start" step-id="5">
      ...
      <div class="col-6">
        <div class="mb-3 row">
          ...
          <div class="form-text">
            Describe your business in not more than 6 - 7 lines as per the given
            image
          </div>
    ...
    <div class="row formbold-form-step-7 wizard-form" step-id="7">
      ...
      <div class="col-6">
        ...
        <div class="form-text text-start mb-2">
          Please give us atleast 1 testmonial,3-5 will be great <br />
          You can add more as you get them.
        </div>
        <TestimonialsComponent
          :testimonials="testimonials"
          :testimonial-validate.sync="testimonialValidate"
        />
      </div>
    </div>
    ...
    <div class="row formbold-form-step-8 wizard-form" step-id="8">
      ...
      <div class="col-6 text-start">
        ...
        <h6 class="card-title text-start my-2">
          Social account links(Optional)
        </h6>
        <div
    ...
    <div
      class="row text-center mt-5 p-5 formbold-form-step-10 wizard-form"
      step-id="10"
    >
      <div class="col-12">
        <h1>
    ...
    <div class="row formbold-form-btn-wrapper">
      <div class="col-12 text-center">
        <button
          class="btn btn-sm formbold-back-btn float-start"
          @click="backClick"
        >
          Back
        </button>
        ...
        <button
          ...
          @click="nextClick"
          :class="
            (clickCount === 2 && !serviceValidate) ||
            (clickCount === 6 && !testimonialValidate)
              ? 'disabled'
              : ''
          "
        >
